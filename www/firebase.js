...
exports.scheduleLocalNotification = function (peerjid, eventType, title, text, success, error) {
    exec(success, error, "FirebasePlugin", "scheduleLocalNotification", [peerjid, eventType, title, text]);
};
